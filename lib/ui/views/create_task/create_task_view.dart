...
import 'package:taska/ui/views/create_task/create_task_view.form.dart';
...
import '../../widgets/common/create_task/create_task_color.dart';
import '../../widgets/common/create_task/create_task_date_time.dart';
import '../../widgets/common/create_task/create_task_frequency.dart';
...
class CreateTaskView extends StackedView<CreateTaskViewModel>
    with $CreateTaskView, DateTimePickerMixin {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CreateTaskDateTime(
                              ...
                              timeValidator: (_) => ValidatorUtils.validateStartTime(viewModel.startTime, viewModel.startDate),
                            ),
                            // End date time
                            CreateTaskDateTime(
                              dateTitle: 'End Date',
